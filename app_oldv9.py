...
def load_bahan() -> pd.DataFrame:
    ...
    df["tahun"] = df["deadline"].dt.year
    tri_map = {1: "I", 2: "I", 3: "I", 4: "II", 5: "II", 6: "II", 7: "III", 8: "III", 9: "III", 10: "IV", 11: "IV", 12: "IV"}
    df["triwulan"] = df["deadline"].dt.month.map(tri_map)
...
def inject_dashboard_css() -> None:
    st.markdown("""
        ...
        .header-card { background: #ffffff; border: 1px solid #dbe4ef;  padding: 18px 22px; margin-bottom: 20px; box-shadow: 0 4px 14px rgba(15, 39, 71, 0.06);}
